...
//based on imgui.h file version "1.67 WIP" from Dear ImGui https://github.com/ocornut/imgui
...
CIMGUI_API ImGuiID igDockSpaceOverViewport(ImGuiViewport* viewport,ImGuiDockNodeFlags dockspace_flags,const ImGuiDockFamily* dock_family)
{
    return ImGui::DockSpaceOverViewport(viewport,dockspace_flags,dock_family);
}
...
CIMGUI_API ImGuiDockFamily* ImGuiDockFamily_ImGuiDockFamilyID(ImGuiID family_id,bool compatible_with_family_zero)
{
    return IM_NEW(ImGuiDockFamily)(family_id,compatible_with_family_zero);
}
